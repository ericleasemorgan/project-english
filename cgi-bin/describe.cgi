...
if ( "id" not in input or 'noun' not in input ) :
	...
	print ( '''<html><head><title>Project English - Describe</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - Describe</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a lemmatized noun, this page will return a frequency list of two-word adjective phrases, thus "describing" the input. This is useful for gauging the sentiment towards a thing.</p><form method="GET" action="/cgi-bin/describe.cgi">Identifier: <input type="text" name="id" value="A27006" /><br />Lemmatized noun: <input type="text" name="noun" value="man" /><br />Type: <input type='radio' name='type' value='positive' checked='checked'>positive</input> <input type='radio' name='type' value='negative'>negative</input><br /><input type="submit" value="List descriptions" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />June 13, 2018</p></div></div></body></html>''' )
