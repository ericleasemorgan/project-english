...
if "id" not in input or "words" not in input :
	...
	print ( '''<html><head><title>Project English - Dispersion plot</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - Dispersion plot</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a Project English identifier and a list of words, visualize where the words occur in a text.</p><form method="GET" action="/cgi-bin/dispersion.cgi">Identifier: <input type="text" name="id" value="1302901107" /> Words: <input type="text" name="words" value="love honor justice truth beauty"/><input type="submit" value="Plot" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />April 9, 2018</p></div></div></body></html>''' )
...
# process the input
	...
	print ( '''<html><head><title>Project English - Dispersion plot</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - Dispersion plot</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><img src='http://cds.crc.nd.edu/tmp/dispersion.jpg'/><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />April 9, 2018</p></div></div></body></html>''' )
