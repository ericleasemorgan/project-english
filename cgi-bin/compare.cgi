...
if ( "id" not in input or 'type' not in input ) :
	...
	print ( '''<html><head><title>Project English - Compare &amp; contrast</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/english/etc/style.css"></head><body><div class="header"><h1>Project English - Compare &amp; contrast</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/english/home.html">Home</a></li><li><a href="/english/about/">About and scope</a></li><li><a href="/english/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a type of part-of-speech (noun, verb, or adjective), this page will output a frequency list of conjunctions: this and that, one or another, etc. This helps answer the question, "What is compared &amp; contrasted in this text or corpus?"</p><form method="GET" action="/english/cgi-bin/compare.cgi">Identifier: <input type="text" name="id" value="A27006" /><br />Type of comparison: <input type="radio" name="type" value="N" checked='checked'> noun</input>  <input type="radio" name="type" value="V"> verb</input>  <input type="radio" name="type" value="J"> adjective</input><br /><input type="submit" value="List comparisons" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />June 20, 2018</p></div></div></body></html>''' )
