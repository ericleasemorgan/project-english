...
if ( "id" not in input or 'type' not in input ) :
	...
	print ( '''<html><head><title>Project English - Parts-of-speech &amp; named-entities</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - Parts-of-speech &amp; named-entities</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Use this page to list the frequency of selected parts-of-speech and named entities existing in a document. This is is useful for gauging what & how things are discussed.</p><form method="GET" action="/cgi-bin/posent.cgi">Identifier: <input type="text" name="id" value="A27006" /><br />Selection: <select name='type'>
