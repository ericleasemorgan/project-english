...
if "id" not in input or "n" not in input :
	...
	print( 'Content-Type: text/html\n' )
	print ( '''<html><head><title>Project English - List ngrams</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - List ngrams</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a Project English identifier and an integer, this form returns a frequency list of ngrams (i.e. one-word, two-word, three-word phrases) from the identified text. Save the result and do further analysis with the use of your favorite text editor, spreadsheet, database, or statistics application(s).</p><form method="GET" action="/cgi-bin/id2ngrams.cgi">Identifier: <input type="text" name="id" value="1302901107" /><br />Size of ngram: <input type="text" name="n" value="2" size='2' width='2' /><br /><input type="submit" value="List ngrams" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />April 9, 2018</p></div></div></body></html>''' )
