...
if "id" not in input or "word" not in input :
	...
	print( 'Content-Type: text/html\n' )
	print ( '''<html><head><title>Project English - Simple concordance</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - Simple concordance</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a Project English identifier and an word, this form returns a list of lines from the given text containing the word -- a keyword in context search result.</p><form method="GET" action="/cgi-bin/concordance.cgi">Identifier: <input type="text" name="id" value="1302901107" /><br />Word: <input type="text" name="word" value="love"/><br /><input type="submit" value="List lines" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />April 9, 2018</p></div></div></body></html>''' )
