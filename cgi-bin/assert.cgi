...
if ( "id" not in input or 'noun' not in input or 'verb' not in input ) :
	...
	print ( '''<html><head><title>Project English - List assertions</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/etc/style.css"></head><body><div class="header"><h1>Project English - List assertions</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/home.html">Home</a></li><li><a href="/about/">About and scope</a></li><li><a href="/cgi-bin/search.cgi">Search</a></li></ul></div><div class="col-9 col-m-9"><p>Given a lemmatized noun and a lemmatized verb, this page will output a list positive or negative assertions in the form of noun-verb-(noun or adjective). This is useful for extracting the definitions of things, listing what things have, or listing what things do. For example, try these combinations: <a href="http://cds.crc.nd.edu/cgi-bin/assert.cgi?id=A27006&amp;noun=man&amp;verb=be&amp;type=positive">man be</a>, <a href="http://cds.crc.nd.edu/cgi-bin/assert.cgi?id=A27006&amp;noun=truth&amp;verb=be&amp;type=positive">truth be</a>, <a href="http://cds.crc.nd.edu/cgi-bin/assert.cgi?id=A27006&amp;noun=man&amp;verb=have&amp;type=positive">man have</a>, <a href="http://cds.crc.nd.edu/cgi-bin/assert.cgi?id=A27006&amp;noun=-PRON-&amp;verb=do&amp;type=positive">-PRON- do</a>. Use the summarize tool to list the frequently used lemmatized nouns, verbs, etc.</p><form method="GET" action="/cgi-bin/assert.cgi">Identifier: <input type="text" name="id" value="A27006" /><br />Lemmatized noun: <input type="text" name="noun" value="man" /><br />Lemmatized verb: <input type="text" name="verb" value="be" /><br />Type: <input type='radio' name='type' value='positive' checked='checked'>positive</input> <input type='radio' name='type' value='negative'>negative</input><br /><input type="submit" value="List assertions" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Project English<br />June 13, 2018</p></div></div></body></html>''' )
