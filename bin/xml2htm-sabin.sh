...
# xml2htm-sabin.sh - create rudimentary HTML from XML
# usage: find collections/sabin -name *.xml | parallel -j12 ./bin/xml2htm-sabin.sh {} 
...
STYLESHEET='./etc/xml2htm-sabin.xsl'
FILE=$1
